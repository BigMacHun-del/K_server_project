...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<BaseResponse<Void>> handleServiceErrorException(ServiceErrorException e) {
        ...
        return ResponseEntity
                ...
                .body(BaseResponse.fail(String.valueOf(e.getHttpStatus().value()), e.getMessage(), null));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> handleIllegalArgumentException(IllegalArgumentException e) {
        ...
        return ResponseEntity
                ...
                .body(BaseResponse.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), MSG_NOT_VALID_VALUE, null));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(BaseResponse.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), e.getAllErrors().get(0).getDefaultMessage(), null));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> handleDataIntegrityViolationException(DataIntegrityViolationException e) {
        ...
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(BaseResponse.fail(String.valueOf(HttpStatus.BAD_REQUEST.value()), MSG_DATA_INSERT_FAIL, null));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        return ResponseEntity
                ...
                .body(BaseResponse.fail(String.valueOf(HttpStatus.METHOD_NOT_ALLOWED.value()), e.getMessage(), null));
    }
    ...
    public ResponseEntity<BaseResponse<Void>> handleException(Exception e) {
        ...
        return ResponseEntity
                ...
                .body(BaseResponse.fail(String.valueOf(HttpStatus.INTERNAL_SERVER_ERROR.value()), MSG_SERVER_ERROR_OCCUR, null));
    }
}
